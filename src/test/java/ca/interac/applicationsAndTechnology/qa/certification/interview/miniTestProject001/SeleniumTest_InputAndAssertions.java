 ...
 * 
 * Create a script to ensure that searching for the term "transcendentalism"
 * yields no result.
 * 
 ...
 */
public class SeleniumTest_InputAndAssertions {
	...
	public void beforeClass() {
		logger.atDebug().log("Test class starting %s", SeleniumTest_InputAndAssertions.class.getCanonicalName());
	}

	@AfterClass
	public void afterClass() {
		logger.atDebug().log("Test class ended %s", SeleniumTest_InputAndAssertions.class.getCanonicalName());
	}
